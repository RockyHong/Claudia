...
import { trackProject, removeProject, listProjects } from "./project-storage.js";
...
describe("trackProject", () => {
  ...
  it("updates lastSeen for an existing project", async () => {
    ...
    const storedProjects = [
      { path: "/home/user/existing-dedup-project", name: "existing-dedup-project", lastSeen: oldTs },
    ];
  ...
  it("sorts by lastSeen descending", async () => {
    const older = { path: "/home/user/sort-older-project", name: "sort-older-project", lastSeen: 500 };
    const newer = { path: "/home/user/sort-newer-project", name: "sort-newer-project", lastSeen: 1500 };
...
describe("removeProject", () => {
  ...
  it("filters out the specified path", async () => {
    const projects = [
      ...
      { path: "/home/user/remove-project", name: "remove-project", lastSeen: 1000 },
    ];
    fs.readFile.mockResolvedValue(JSON.stringify(projects));
